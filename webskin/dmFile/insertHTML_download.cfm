...
<cfoutput><a href="#application.url.webroot#/download.cfm?downloadfile=#encodeForHTMLAttribute(stobj.objectid)#&typename=#encodeForHTMLAttribute(stobj.typename)#&fieldname=filename">#encodeForHTML(stobj.title)#</a></cfoutput>
