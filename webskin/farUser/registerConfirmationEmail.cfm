...
<cfmail from="#application.config.general.adminemail#" to="#stProfile.emailAddress#" subject="#application.fapi.getResource('coapi.farLogin.register.confirmationemail@subject','New User Confirmation Email')#" type="html">
