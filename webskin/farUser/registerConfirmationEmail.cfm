...
<cfmail from="#application.fapi.getConfig("general","adminemail")#" to="#stProfile.emailAddress#" subject="#application.fapi.getResource('coapi.farLogin.register.confirmationemail@subject','New User Confirmation Email')#" type="html">
	<admin:resource key="coapi.farLogin.register.confirmationemail@html" var1="#encodeForHTML(stProfile.firstname)#" var2="#encodeForHTML(stProfile.lastname)#" var3="#application.fapi.getLink(objectid=stObj.objectid,view='registerConfirmationAccepted',includeDomain=true)#"><cfoutput>
		<p>Hello {1} {2}</p>
