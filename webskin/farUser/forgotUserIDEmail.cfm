...
<cfmail from="#application.config.general.adminemail#" to="#stProfile.emailAddress#" subject="#application.fapi.getConfig("general", "sitetitle", "FarCry")# Webtop #application.fapi.getResource('coapi.farLogin.clientidreminder@subject','Username Retrieval')#" type="html">
