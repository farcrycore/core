...
<cfmail from="#application.fapi.getConfig("general","adminemail")#" to="#stProfile.emailAddress#" subject="#application.fapi.getResource('coapi.farLogin.resetpassword@subject','Password reset')#" type="html">
	<admin:resource key="coapi.farLogin.resetpassword@html" var1="#encodeForHTML(stProfile.firstname)#" var2="#encodeForHTML(stProfile.lastname)#" var3="#application.fapi.getLink(type='farUser',view='forgotPasswordReset',urlParameters='rh=#stProperties.forgotPasswordHash#',includeDomain=true)#"><cfoutput>
		<p>Hello {1} {2}</p>
