...
<cfswitch expression="#arguments.stParam.onclick#">
	<cfcase value="true">
		...
		<cfelse>
			<cfoutput><a href="#onClickImagePath#"><img src="#application.fapi.getImageWebRoot()##stObj[arguments.stParam.ImageSize]#" height="#stObj.height#" width="#stObj.width#" class="#arguments.stParam.class#" alt="#HTMLEditFormat(arguments.stParam.alt)#" /></a></cfoutput>
		</cfif>
	</cfcase>
	<cfcase value="no">
