...
<cfoutput>
	<script type="text/javascript">
		...
		profileWin = window.open('#application.url.farcry#/facade/view.cfm?objectID=#session.dmProfile.objectID#&method=displayUserEdit','edit_profile','width=550,height=500,left=200,top=100,scrollbars=1');
	</script>
</cfoutput>
