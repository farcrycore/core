...
<!--- @@author: Matthew Bryant --->
	...
	<script type="text/javascript">
		...
		if(typeof SWFObject != "undefined") {
			var so = new SWFObject("#application.url.fileroot##stobj.flashMovie#", "#stobj.objectid#_flashMovie", "#stobj.flashWidth#", "#stobj.flashHeight#", "#stobj.FlashVersion#", "#stobj.flashBgcolor#");
