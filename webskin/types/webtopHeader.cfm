				...
				<div class="farcry-header-utility">
					...
					<div class="farcry-header-user dropdown">
						...
						<ul class="dropdown-menu pull-right">
							<li><a href="#application.url.webtop##application.url.CONJURER#?id=dashboard&typename=dmProfile&objectid=#session.dmProfile.objectid#&bodyView=editOwn"><admin:resource key="coapi.dmProfile.general.editprofile">Edit Profile</admin:resource></a></li>
							</cfoutput>
							...
							<li class="divider"></li>
							<li><a href="#application.url.webtop##application.url.CONJURER#?logout=1"><admin:resource key="coapi.dmProfile.general.logout">Logout</admin:resource></a></li>
						</ul>
					</div>
				</div>
