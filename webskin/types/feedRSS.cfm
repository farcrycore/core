...
<cfif arguments.stParam.bAuthor>
	...
	<cfif not structisempty(arguments.stParam.author) and len(arguments.stParam.author.emailAddress)>
		<cfoutput><author>#arguments.stParam.author.emailAddress#<cfif len(arguments.stParam.author.firstname) or len(arguments.stParam.author.lastname)> (#encodeForXML(arguments.stParam.author.firstname)# #encodeForXML(arguments.stParam.author.lastname)#)</cfif></author></cfoutput>
...
<cfif len(arguments.stParam.media)>
	...
	<cfif arguments.stParam.bAuthor and not len(arguments.stParam.itunesauthor) and not structisempty(arguments.stParam.author) and len(arguments.stParam.author.emailAddress)>
		<cfoutput>
			<itunes:author>#encodeForXML(arguments.stParam.author.firstname)# #encodeForXML(arguments.stParam.author.lastname)#<cfif len(arguments.stParam.author.firstname) or len(arguments.stParam.author.lastname)> (#encodeForXML(arguments.stParam.author.emailAddress)#)</cfif></itunes:author>
		</cfoutput>
	</cfif>
