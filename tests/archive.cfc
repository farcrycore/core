<cfcomponent displayname="Archive" hint="Archive tests" extends="farcry.plugins.testMXUnit.tests.FarcryTestCase" output="false">
	...
	<cffunction name="setUp" returntype="void" access="public">
		...
		<cfset createTemporaryObject(typename="dmInclude",objectid=this.testIncludeApproved,status="approved",title="Archive",label="Archive",categories=application.catid.root) />
	...
	<cffunction name="status_rollback" displayname="Object With Status - Rollback" hint="Check that an archive is created and the object is updated after a rollback" returntype="void" access="public" dependsOn="status_editapproved">
		<cfset var stObj = application.fapi.getContentObject(typename="dmInclude",objectid=this.testIncludeApproved) />
		<cfset var q = "" />
		<cfset var stArchive = structnew() />
		...
		<cfset application.fapi.getContentType("dmArchive").rollbackArchive(objectid=this.testIncludeApproved,archiveID=q.objectid[1],typename="dmInclude")>
	...
	<cffunction name="status_undelete" displayname="Object With Status - Undelete" hint="Check that the bDeleted flag is removed after rolling back a deleted object" returntype="void" access="public">
		<cfset var stObj = application.fapi.getContentObject(typename="dmInclude",objectid=this.testIncludeApproved) />
		<cfset var q = "" />
		<cfset var stArchive = structnew() />
	...
	<cffunction name="tree_undelete_leafwithparent" displayname="Tree Object - Undelete leaf (parent exists)" hint="Check that undeleting a leaf restores it to its original parent" returntype="void" access="public" dependsOn="version_undelete,metadata_tree_leafintree">
		...
		<cfset stArchive = application.fapi.getContentType("dmArchive").rollbackArchive(objectid=this.testNavigationLeaf,archiveID=q.objectid[1],typename="dmHTML")>
	...
	<cffunction name="tree_undelete_leafwithnoparent" displayname="Tree Object - Undelete leaf (parent does not exist)" hint="Check that undeleting a leaf restores it to the 'Undelete' node" returntype="void" access="public" dependsOn="version_undelete,metadata_tree_notintree">
		...
		<cfset application.fapi.getContentType("dmArchive").rollbackArchive(objectid=this.testNavigationLeaf,archiveID=q.objectid[1],typename="dmHTML")>
	...
	<cffunction name="tree_undelete_nodewithparent" displayname="Tree Object - Undelete node (parent exists)" hint="Check that undeleting a node restores it to its original parent" returntype="void" access="public" dependsOn="version_undelete,metadata_tree_leafintree">
		...
		<cfset application.fapi.getContentType("dmArchive").rollbackArchive(objectid=this.testNavigationChild,archiveID=q.objectid[1],typename="dmNavigation")>
	...
	<cffunction name="metadata_tree_navigationdelete" displayname="Metadata - Delete branch" hint="Check that deleting a branch stores parent and children information for child content" returntype="void" access="public" dependsOn="version_editapproved">
		...
		<cfset assertEquals("delete",q.event,"Incorrect child archive event") />
		...
		<cfset assertEquals("delete",q.event,"Incorrect leaf archive event") />
