...
<cfparam name="attributes.fieldLabelKeywords" default="#application.rb.getResource("keywordsLabel")#">
<cfparam name="attributes.fieldLabelExtendedMetadata" default="#application.rb.getResource("extendedMetadata")#">
...
<label for="extendedmetadata" style="width:360px"><b>#attributes.fieldLabelExtendedMetadata#</b>
	<a href="javascript:void(0);" onclick="doToggle('extendedmetadata','bHasMetaData');"><cfif trim(attributes.FieldValueExtendedMetadata) EQ ""><img src="#application.url.farcry#/images/no.gif" id="tglextendedmetadata_image" border="0" alt="#application.rb.getResource("extendedMetadata")#"><cfelse>
		<img src="#application.url.farcry#/images/yes.gif" id="tglextendedmetadata_image" border="0" alt="#application.rb.getResource("noExtendedMetadata")#"></cfif>
	</a>
	...
	#application.rb.getResource("insertedInHeadBlurb")#
	</span>
...
//		objTglImage.alt = "#application.rb.getResource("noExtendedMetadata")#";
		if(bHiddenFieldName)
			objTglHiddenValue.value = 1;
	}else {
		objTgl.style.display = "none";
		objTglImage.src = "#application.url.farcry#/images/no.gif";
//		objTglImage.alt = "#application.rb.getResource("extendedMetadata")#";
		if(bHiddenFieldName)
