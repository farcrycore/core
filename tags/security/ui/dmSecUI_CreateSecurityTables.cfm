...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/tags/security/ui/dmSecUI_CreateSecurityTables.cfm,v 1.1 2003/04/08 08:52:20 paul Exp $
$Author: paul $
...
<cfscript>
	...
	stUD=request.dmsec.oAuthentication.getUserDirecotry();
