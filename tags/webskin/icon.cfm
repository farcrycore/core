...
<cfif thistag.ExecutionMode eq "start">
	...
	<cfoutput><img src="#iconURL#" <cfif len(attributes.id)> id="#attributes.id#"</cfif><cfif len(attributes.class)> class="#attributes.class#"</cfif><cfif len(attributes.style)> style="#attributes.style#"</cfif> alt="#attributes.alt#" /></cfoutput>
