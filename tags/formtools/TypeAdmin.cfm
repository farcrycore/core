	...
	<cfswitch expression="#attributes.aColumns[i].columntype#">
		...
		<cfcase value="Categories">
			...
			<cfinvoke component="#application.packagepath#.farcry.category" method="getCategories" returnvariable="lSelectedCategoryID">
				<cfinvokeargument name="objectID" value="#recordset.objectID#"/>
			...
			<td <cfif len(attributes.aColumns[i].style)>style="#attributes.aColumns[i].style#"</cfif>>
				<cfloop list="#lSelectedCategoryID#" index="i">
					
							
					<cfinvoke component="#application.packagepath#.farcry.category" method="getCategoryNamebyID" returnvariable="CatName">
						<cfinvokeargument name="categoryid" value="#i#"/>
					</cfinvoke>
