...
<cfif thistag.ExecutionMode EQ "Start">
		...
		<cfoutput>	
			...
			<input type="hidden" name="#Request.farcryForm.Name#FarcryFormSubmitButtonClicked" id="#Request.farcryForm.Name#FarcryFormSubmitButtonClicked" value="" /><!--- This contains the name of the farcry button that was clicked --->
