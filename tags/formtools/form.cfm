...
<cfif ListValueCountNoCase(getbasetaglist(),"CF_FORM") EQ 1>
	...
	<cfif thistag.ExecutionMode EQ "Start" AND NOT isDefined("Request.farcryForm.Name")>
		...
		<cfif attributes.bAjaxSubmission>
			...
			<cfset attributes.onSubmit = "#attributes.onSubmit#;farcryForm_ajaxSubmission('#attributes.Name#','#attributes.Action#','#attributes.ajaxMaskMsg#','#attributes.ajaxMaskCls#', #attributes.ajaxTimout#);return false;" />
