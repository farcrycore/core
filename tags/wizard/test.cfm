...
<form action="#application.url.farcry#/edittabEdit.cfm?objectid=A43034AD-EBF1-84EB-056F4D76CED61419" class="f-wrap-1 wider f-bg-short" name="editform" method="post">	
	<fieldset>
...
<h3>General Info: <span class="highlight">Breathe Creativity - Welcome</span></h3>
	...
	<label for="extendedmetadata"><b>Extended Metadata</b>
		...
		<a href="javascript:void(0);" onclick="doToggle('extendedmetadata','bHasMetaData');"><img src="#application.url.farcry#/images/no.gif" id="tglextendedmetadata_image" border="0" alt="Extended Metadata"></a>
