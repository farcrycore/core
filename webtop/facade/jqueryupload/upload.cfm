...
<cfset stProperties.objectid = url.objectid />
<cfset stProperties[url.property] = "#stMetadata.ftDestination#/#cleanFileName#" />
<cfset stResult = application.fapi.getContentType(url.typename).setData(stProperties="#stProperties#", bSessionOnly="true") />
