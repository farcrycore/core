...
var tinyMCEImageList = new Array(
	...
	<cfloop query="qImages">
		["<cfif len(qImages.label)>#qImages.label#<cfelse>#qImages[url.imageField][currentRow]#</cfif>", "#application.fapi.getImageWebRoot()##qImages[url.imageField][currentRow]#"]<cfif currentRow LT qImages.RecordCount>,<cfset currentrow = currentrow + 1></cfif>
	</cfloop>
);
</cfoutput>