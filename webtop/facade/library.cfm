			...
			<div id="pane2">		
				...
				<ft:form>
					...
					<div>
						...
						<ft:farcryButton type="button" value="Complete" onclick="self.blur();window.close();" />	
					</div>
					</cfoutput>
	...
	<cfsavecontent variable="returnString">
		...
		<ft:form>
			...
			<cfelse>
				...
				<cfelse>
					<ft:farcryButtonPanel indentForLabel="false">
						<ft:farcryButton type="button" value="Complete" onclick="self.blur();window.close();return false;" />	
					</ft:farcryButtonPanel>	
				</cfif>	
			</cfif>
