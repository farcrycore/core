...
<div class="FormSubTitle">#application.rb.getResource("rSSFeeds")#</div>
...
<table width="100%" cellspacing="1"> 
	...
	<tr>
		<td>
			...
			<tr class="dataheader">
				<td align="center"> #application.rb.getResource("feed")# </td>
				<td align="center" width="80"> #application.rb.getResource("edit")# </td>
				<td align="center" width="80"> #application.rb.getResource("preview")# </td>
				<td align="center" width="80"> #application.rb.getResource("validate")# </td>
				<td align="center" width="80"> #application.rb.getResource("delete")# </td>
			</tr>
         </cfoutput>
			...
			<cfscript>
			  ...
			  <tr class="#IIF(currentrow MOD 2, de("dataOddRow"), de("dataEvenRow"))#"> 
				...
				<td align="center">
					...
					<input type="button" name="edit" value="#application.rb.getResource("edit")#" onClick="location.href='#editObjectURL#';">
				</td>
				<td align="center">
					<input type="button" name="preview" value="#application.rb.getResource("preview")#" onClick="window.open('#previewURL#');">
				</td>
				<td align="center">
					<input type="button" name="validate" value="#application.rb.getResource("validate")#" onClick="window.open('#validateURL#');">
				</td>
				<td align="center">
					<input type="submit" name="delete" value="#application.rb.getResource("delete")#" onClick="return confirmDelete('#recordset.objectid#')">
					</form>
				</td>
			  </tr>
			</cfoutput>
