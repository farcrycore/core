		...
		switch (command) {
			...
			case "mcefarcrycontenttemplates":
				...
				if (user_interface) {
					...
					farcrycontenttemplates['file'] = '../../plugins/farcrycontenttemplates/popup.cfm?objectid'; // Relative to theme
					farcrycontenttemplates['width'] = 500;
					farcrycontenttemplates['height'] = 400;
