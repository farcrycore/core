...
tinymce.PluginManager.add('image_farcry', function(editor) {
	...
	function createImageList(callback) {
		return function() {
			var imageList = editor.settings.image_list, data = getFormData();
				...
				$j.ajax({
					...
					success: function(data){
						if (typeof(data)==="string")
							data = tinymce.util.JSON.parse(data).images;
	...
	function showDialog(imageList) {
		...
		var width, height, imageListCtrl, bulkUploadCtrl, bulkUploadWatch;
		...
		if (imageList && buildImageList().length > 1) {
			imageListCtrl = {
				name: 'target',
				type: 'listbox',
				label: 'Image list',
			...
			imageListCtrl = {
				type: 'container',
				label: 'Image list',
				html: 'No images attached - upload or attach some images to select them here'
			};
		}
