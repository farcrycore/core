...
<sec:CheckPermission error="true" permission="AdminCOAPITab">
	...
	<skin:flexWrapper SWFSource="#application.url.farcry#/admin/ui/swf/multipleUploader.swf" id="multiple" flashVars="#lcase(session.urltoken)#&bulkimgUploadURL=#application.url.webtop#/admin/bulkimgUpload.cfm&flexCategoryFacadePath=#flexCategoryFacadePath#">
</sec:CheckPermission>
