...
<sec:CheckPermission error="true" permission="AdminGeneralTab">
	...
	<fieldset>
		...
		<option value="#application.rb.getResource('fuadmin.labels.alias@label','Alias')#"<cfif form.searchIn eq "mapping"> selected="selected"</cfif>>#application.rb.getResource("fuadmin.labels.alias@lable","Alias")#</option>
		<option value="#application.rb.getResource('fuadmin.labels.contentitem@label','Content Item')#"<cfif form.searchIn eq "object"> selected="selected"</cfif>>#application.rb.getResource("fuadmin.labels.contentitem@label","Content Item")#</option>
		</select>
		<br />
		</label>
