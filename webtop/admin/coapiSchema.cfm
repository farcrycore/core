...
|| VERSION CONTROL ||
$Header: /cvs/farcry/core/webtop/admin/coapiSchema.cfm,v 1.7 2005/08/16 05:53:23 pottery Exp $
$Author: pottery $
...
<sec:CheckPermission error="true" permission="AdminCOAPITab">
	<cfoutput><h3>#application.rb.getResource("COAPIschema")#</h3></cfoutput>
