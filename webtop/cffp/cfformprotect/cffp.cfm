...
<cfset cffpPath = "#application.url.webtop#/cffp/cfformprotect">
...
<cfif cffpConfig.mouseMovement>
	...
	<cfoutput><input type="hidden" name="formfield1234567891" id="formfield1234567891" value=""></cfoutput>
	<skin:htmlHead id="cffp_mouseMovement">
		<cfoutput>
			<script type='text/javascript' src='#cffpPath#/js/mouseMovement.js'></script></cfoutput>
	</skin:htmlHead>
</cfif>
...
<cfif cffpConfig.usedKeyboard>
	<!--- If the types on their keyboard, put the amount of keys pressed in this field.
				cffpVerify.cfm will make sure the user at least used their keyboard. A spam
				bot won't trigger this --->
	<cfoutput><input type="hidden" name="formfield1234567892" id="formfield1234567892" value=""></cfoutput>
	<skin:htmlHead id="cffp_usedKeyboard">
		<cfoutput>
			<script type='text/javascript' src='#cffpPath#/js/usedKeyboard.js'></script></cfoutput>
	</skin:htmlHead>
</cfif>
...
<cfif cffpConfig.timedFormSubmission>
	...
	<cfoutput><input type="hidden" name="formfield1234567893" value="#blurredDate#,#blurredTime#"></cfoutput>
</cfif>
...
<cfif cffpConfig.hiddenFormField>
	...
	<cfoutput><span style="display:none">Leave this field empty <input type="text" name="formfield1234567894" value=""></span></cfoutput>
</cfif>