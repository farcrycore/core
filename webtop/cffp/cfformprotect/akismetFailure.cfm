...
<cfif structKeyExists(url,"type")>
	<cftry>
		...
		<cfhttp url="http://#cffpConfig.akismetAPIKey#.rest.akismet.com/1.1/submit-#url.type#" timeout="10" method="post">
			...
			<cfhttpparam name="user_ip" type="formfield" value="#application.fc.lib.esapi.DecodeFromURL(url.user_ip,'utf-8')#">
			<cfhttpparam name="user_agent" type="formfield" value="CFFormProtect/1.0 | Akismet/1.11">
			<cfhttpparam name="referrer" type="formfield" value="#application.fc.lib.esapi.DecodeFromURL(url.referrer,'utf-8')#">
			<cfhttpparam name="comment_author" type="formfield" value="#application.fc.lib.esapi.DecodeFromURL(url.comment_author,'utf-8')#">
			<cfif cffpConfig.akismetFormEmailField neq "">
			<cfhttpparam name="comment_author_email" type="formfield" value="#application.fc.lib.esapi.DecodeFromURL(url.comment_author_email,'utf-8')#">
			</cfif>
			<cfif cffpConfig.akismetFormURLField neq "">
			<cfhttpparam name="comment_author_url" type="formfield" value="#application.fc.lib.esapi.DecodeFromURL(url.comment_author_url,'utf-8')#">
			</cfif>
			<cfhttpparam name="comment_content" type="formfield" value="#application.fc.lib.esapi.DecodeFromURL(url.comment_content,'utf-8')#">
		</cfhttp>
		<cfcatch type="any">
