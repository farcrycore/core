...
<!--- </cfif> --->
    ...
    <td><a href="#application.url.farcry#/navajo/unlock.cfm?objectid=#qLockedObjects.objectid#&typename=#qLockedObjects.typename#&return=home" target="_parent">[#application.rb.getResource("unlock")#]</a></td>
</tr></cfloop>
</table>
<!--- show link to all locked Objects --->
<cfif qLockedObjects.recordcount gt url.lockedEndRow>
    <ul><li><strong><a href="#application.url.farcry#/overview/home.cfm?lockedEndRow=#qLockedObjects.recordcount#">#application.rb.getResource("showAll")#</a></strong></li></ul>
<cfelseif url.lockedEndRow neq 5>
    <ul><li><strong><a href="#application.url.farcry#/overview/home.cfm?lockedEndRow=5">#application.rb.getResource("showRecent5")#</a></strong></li></ul>
</cfif>
</cfif>
</cfoutput>
