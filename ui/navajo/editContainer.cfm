<!--- This page started as a test harness for editing container rules - if you are reading this then this page
has not actually been rewritten properly :)  PH
 --->
...
<cfinvoke component="#application.packagepath#.rules.rules"
 method="getRules" returnvariable="qRules"/>
<!---  <cfdump var="#qRules#"> --->
<!--- A function to make dealing with custom rules slightly less painless --->
		...
		<td  align="left">
			...
			<tr>
				<td  align="center" valign="top">
					...
					<select name="source" size="8" style="font-size:7pt; border: 0px none;">
						<cfloop query="qRules">
