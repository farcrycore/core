...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/ui/admin/Attic/diagTreeNodes.cfm,v 1.3 2003/06/10 07:05:41 brendan Exp $
$Author: brendan $
$Date: 2003/06/10 07:05:41 $
$Name: b131 $
$Revision: 1.3 $
	...
	<cflock name="moveBranchNTM" type="EXCLUSIVE" timeout="3" throwontimeout="Yes">
		<cfloop list="#form.objectid#" index="object">
			<cfscript>
				...
				oTree.moveBranch(parentid=form.navalias, objectid=object);
			</cfscript>
		</cfloop>
