...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/admin/reporting/statsSearchesMostPopular.cfm,v 1.2 2004/07/15 01:51:48 brendan Exp $
$Author: brendan $
...
<cfif iStatsTab eq 1>
	...
	<cfoutput>
	<div class="formtitle">#application.adminBundle[session.dmProfile.locale].mostPopularSiteSearches#</div>
