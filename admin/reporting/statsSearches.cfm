...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/admin/reporting/statsSearches.cfm,v 1.1 2003/09/04 06:34:01 brendan Exp $
$Author: brendan $
...
<cfif iStatsTab eq 1>
	...
	<cfoutput>
	<div class="formtitle">Recent Searches</div>
		...
		<tr>
			<td valign="top" nowrap>
				...
				<tr>
					...
					<th class="dataheader">Results</td>
					<th class="dataheader">Date/Time</td>
					<th class="dataheader">Locale</td>
					<th class="dataheader">Remote IP</td>
				</tr>
				...
				<cfloop query="qSearches">
					<tr class="#IIF(qSearches.currentRow MOD 2, de("dataOddRow"), de("dataEvenRow"))#">
						...
						<td align="center">#dateFormat(logDateTime,"dd-mmm-yyyy")# #timeFormat(logDateTime,"hh:mm")#</td>
