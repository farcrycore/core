...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/admin/reporting/statsSearchesNoResults.cfm,v 1.5 2005/08/17 03:28:39 pottery Exp $
$Author: pottery $
...
<cfif iStatsTab eq 1>
	...
	<cfif qSearches.recordcount>
				...
				<fieldset>
					...
					<h3>#application.adminBundle[session.dmProfile.locale].noResultSiteSearches#</h3>
