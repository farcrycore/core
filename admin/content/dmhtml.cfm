...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/admin/content/dmhtml.cfm,v 1.2.2.1 2006/01/04 07:45:53 paul Exp $
$Author: paul $
...
<widgets:typeadmin 
	typename="dmHTML"
	permissionset="news"
	title="#application.adminBundle[session.dmProfile.locale].SiteTreeContentHtmlAdministration#"
	bdebug="0">
</widgets:typeadmin>
