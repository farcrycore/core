...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/admin/scheduledTasks/verityUpdate.cfm,v 1.2 2003/09/19 07:26:51 brendan Exp $
$Author: brendan $
$Date: 2003/09/19 07:26:51 $
$Name: b201 $
$Revision: 1.2 $
...
<cfloop collection="#stCollections#" item="key">
		...
		<cfif NOT structKeyExists(stVerity, "#application.applicationname#_#key#")>
			...
			<cfflush />
			<cfcollection action="CREATE" collection="#application.applicationname#_#key#" path="#server.coldfusion.rootdir#/verity/collections/" language="English">
