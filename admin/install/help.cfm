...
<cfswitch expression="#url.topic#">
	<cfcase value="siteName">
		...
		Do not use FarCry_App as your site name.
	</cfcase>
	...
	<cfcase value="dbOwner">
		...
		Owner of the database tables to be created.<p></p>
	...
	<cfcase value="domain">
		...
		Defaults to localhost<p></p>
		No need for port numbers here.
	</cfcase>
	...
	<cfcase value="deleteApp">
		<strong>Delete FarCry_App on completion</strong><p></p>
		When selected, the FarCry_App directory will be deleted at the end of the install process. Leave unchecked if you wish to perform multiple installs.<p></p>
	</cfcase>
</cfswitch>
