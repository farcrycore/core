...
<cfswitch expression="#url.topic#">
	<cfcase value="siteName">
		...
		Do not use any template project names as your site name.
	</cfcase>

	<cfcase value="domain">
		<strong>Domain Name</strong><p></p>
		This is the domain you are using for your setup here.<p></p>
		Your entry here will be used to make some checks to ensure you have the correct web mappings/alias in place.<p></p>
	</cfcase>
	...
	<cfcase value="farcryMapping">
		...
		Use the name set in your webserver mappings that pointed to core/admin.<p></p>
