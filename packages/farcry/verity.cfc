...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/packages/farcry/verity.cfc,v 1.2 2003/09/24 02:26:55 brendan Exp $
$Author: brendan $
...
<cfcomponent displayName="Verity Search" hint="CFC based around verity search engine">
	...
	<cffunction name="buildCollection" output="no" hint="creates new verity collection">
		...
		<cfargument name="path" required="yes" default="#server.coldfusion.rootdir#/verity/collections/" hint="Name of collection to be created">
