...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/packages/farcry/_config/defaultEWebEditPro.cfm,v 1.2 2003/09/10 12:21:48 brendan Exp $
$Author: brendan $
...
|| DESCRIPTION || 
$Description: deploys eWebEditPro config file $
$TODO: $
