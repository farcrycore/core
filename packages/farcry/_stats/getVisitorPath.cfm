...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/packages/farcry/_stats/getVisitorPath.cfm,v 1.2 2003/04/28 07:40:14 brendan Exp $
$Author: brendan $
...
<cfquery name="qTemp" datasource="#stArgs.dsn#">
	SELECT NavId, PageId, logDateTime
	FROM #application.dbowner#stats
	WHERE sessionId = '#stArgs.sessionId#'
		AND navid <> pageId
