						...
						<cfoutput>
							...
							function toggle#arguments.fieldname#(){
								...
								if (bfieldvisible#arguments.fieldname# == 0){
									...
									document.getElementById('#arguments.fieldname#Input').value = 'now';
									updateDateJSField('#arguments.fieldname#', 'dd MMM yyyy hh:mm tt');
									document.getElementById('#arguments.fieldname#Input').value = '';
								} else {
