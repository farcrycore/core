						...
						<cfif arguments.stMetadata.ftAllowUpload>
					    	<div id="#arguments.fieldname#_upload" class="upload-view" style="display:none;">
								...
								<div style="margin-left:15px">
						    		...
						    		<div id="#arguments.fieldname#_uploaderror" class="ui-state-error ui-corner-all" style="padding:0.7em;margin-top:0.7em;margin-bottom:0.7em;<cfif not len(error)>display:none;</cfif>">#error#</div>
	    	...
	    	<cfif len(arguments.existingfile)>
				...
				<cftry>
					...
					<cfcatch type="uploaderror">
						<cfset application.fc.lib.cdn.ioMoveFile(source_location="archive",source_file=archivedFile,dest_location="images",dest_file=arguments.existingFile) />
	  	...
	  	<cfif fileexists(arguments.localfile)>
			...
			<cfelse>
				...
				<cfelseif listFindNoCase(arguments.allowedExtensions,listlast(arguments.localfile,"."))>
					<cfset uploadFileName = application.fc.lib.cdn.ioMoveFile(source_localpath=arguments.localpath,dest_location="images",dest_file=arguments.destination & "/" & getFileFromPath(arguments.localfile)) />
					<cfset stResult = passed(uploadFileName) />
					<cfset stResult.bChanged = true />
				<cfelse>
