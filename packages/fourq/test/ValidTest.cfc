<cfcomponent name="fourq_test" output="false" extends="farcry.core.packages.types.types" hint="Test component to ensure that the fourq persistence layer works correctly.">
