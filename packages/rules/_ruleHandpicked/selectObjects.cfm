...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/packages/rules/_ruleHandpicked/selectObjects.cfm,v 1.12.2.3 2004/12/17 07:41:51 paul Exp $
$Author: paul $
$Date: 2004/12/17 07:41:51 $
...
<cfoutput>
	...
	<div class="FormTitle">Select Objects</div>
	<div class="FormTable" align="center" style="width:92%">
	<form name="editform" action="" method="post" onSubmit="serializeData(aWDDX,document['forms'].editform.wddx);">
	...
	<tr>
		<td>
			<table style="width:100%" border="1" >
				<tr>
					<td>
						<strong>Select Object Type : </strong>
					</td>
					<td>
				...
				<tr>
					...
					<td>
						...
						<select name="orderdir">
							...
							<option value="DESC" <cfif output.orderdir IS "DESC">selected</cfif>>Descending</option>
						</select>
						
					</td>
				</tr>
				<tr><td colspan="2" align="center"><input type="button" onClick="serializeData(aWDDX,document['forms'].editform.wddx);document['forms']['editform'].submit();" name="search" value="Filter"></td></tr>
			</table>
		</td>
	</tr>										
		...
		<td colspan="3">
			...
			<tr >
				...
				<td align="right" valign="middle">
					<cfif thisPage GT 1>
						<input type="image" src="#application.url.farcry#/images/treeImages/leftarrownormal.gif" value="prev" name="prev"  onclick="serializeData(aWDDX,document['forms'].editform.wddx);document['forms'].editform.thisPage.selectedIndex--;document['forms'].editform.submit();" >
					</cfif>
					Page 
					...
					<cfif thisPage LT numpages>
						<input name="next" type="image" src="#application.url.farcry#/images/treeImages/rightarrownormal.gif" value="next" onclick="serializeData(aWDDX,document['forms'].editform.wddx);document['forms'].editform.thisPage.selectedIndex++;document['forms'].editform.submit();">
					</cfif>
				</td>
			</tr>		
			</table>
