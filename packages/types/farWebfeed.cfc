...
--->
<cfcomponent displayname="Webfeed" hint="Generate web feeds based on your content type. Feeds can be filtered by category. RSS, Atom and iTunes feeds are supported." extends="types" output="false" icon="webfeed" bFriendly="true" bSystem="true">
