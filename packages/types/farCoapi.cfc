...
--->
<cfcomponent displayname="FarCry COAPI" hint="Contains a record per coapi package" extends="farcry.core.packages.types.types" output="false" bObjectBroker="true" ObjectBrokerMaxObjects="10000">
