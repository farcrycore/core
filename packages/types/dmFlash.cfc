...
<cfproperty ftSeq="4" ftFieldSet="General Details" name="metaKeywords" type="string" hint="Keywords or tags to describe this content." required="no" default="" ftlabel="Keywords/Tags">
