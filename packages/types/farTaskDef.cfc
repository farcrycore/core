<cfcomponent displayname="Farcry Task Definition" hint="Task definitions are used as template to create task instances" extends="types" output="false" fuAlias="fc-task-def" bSystem="true">
