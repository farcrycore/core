<cfcomponent displayname="Farcry Task Definition" hint="Workflow definitions are used as template to create workflow instances" extends="types" output="false" description="Acts as a template for the creation of workflow instances" fuAlias="fc-workflow-def" bSystem="true">
