...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/packages/types/_dmEvent/edit.cfm,v 1.19 2005/10/14 02:49:07 guy Exp $
$Author: guy $
...
<cfset tempObject = CreateObject("component",application.types.dmevent.typepath)>
...
<cfset cancelCompleteURL="#application.url.farcry#/content/dmevent.cfm">
