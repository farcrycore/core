...
<cfquery datasource="#arguments.dsn#" result="test">
	DELETE FROM #application.dbowner#refCategories 
	WHERE objectID = '#arguments.objectID#'	
	<cfif isDefined("lDescendents") AND len(lDescendents)>
		AND categoryid IN (<cfqueryparam cfsqltype="cf_sql_varchar" list="true" value="#listappend(lDescendents,arguments.lCategoryIDs)#" />)
	</cfif>
</cfquery>	
