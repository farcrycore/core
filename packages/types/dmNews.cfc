...
|| VERSION CONTROL ||
$Header: /cvs/farcry/farcry_core/packages/types/dmNews.cfc,v 1.20 2005/10/05 23:42:42 guy Exp $
$Author: guy $
...
--->
<cfcomponent extends="farcry.farcry_core.packages.types.versions" displayname="News" hint="Dynamic news data" bSchedule="1">
<!------------------------------------------------------------------------
type properties
------------------------------------------------------------------------->	
