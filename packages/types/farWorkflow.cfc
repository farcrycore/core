<cfcomponent displayname="Farcry Workflow Instance" hint="Workflow instance contains details of the work to be performed" extends="types" output="false" fuAlias="fc-workflow" bSystem="true">
