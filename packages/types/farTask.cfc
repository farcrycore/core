<cfcomponent displayname="Farcry Task Instance" hint="Task instance used to keep track of work to be done in a workflow." extends="types" output="false" fuAlias="fc-task" bSystem="true">
